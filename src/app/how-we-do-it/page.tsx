...
const steps = [
  {
    ...
    desc: "Every engagement starts the same way — we listen. Before we touch a single campaign, we need to understand your business, your market, and where the real opportunities are hiding.",
    bullets: [
  ...
  },
  {
    ...
    desc: "Armed with real data about your business, we design a bespoke growth plan. Not a generic template — a custom strategy built around your strengths, your market, and your goals.",
    bullets: [
